...
if (isset($_GET['sdata']) && isset($_GET['stype']))
{
    ...
    if($_GET['stype']=='regnum')
    {
        ...
        {
            echo "<tr style='color: black; background-color: #bababa; border-radius: 2px; text-align: center'><td>".$sr['reg_num']."</td><td>".$sr['student_name']."</td><td>".$sr['uidai_number']."</td><td>".$sr['mobile_number']."</td><td><a href='newstudent.php?id=".$sr["id"]."&submittyp=existing'>Select</a></td></tr>";
        }
    }
